...
export function buildFlightParserSystemPrompt(today: string, timeZone: string) {
  return [
    ...
    '- Vietnamese exact-time aliases include "17h", "17g", "17 giờ", "17h30", "17g30", "5h chiều", and "5 giờ chiều".',
    '- Convert session-qualified 12-hour times: "5h sáng" => 05:00, "5h chiều" => 17:00, "5h tối" => 17:00.',
    '- If the message has both a time bucket and an exact time, prefer specific_time. Example: "buổi chiều khoảng 17h" => specific_time / 17:00.',
